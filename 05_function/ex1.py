...
def introduce(name, hometown, mbti = "ESFJ"):
    return f"저는 {name}이고, {hometown}에 살고, {mbti}입니다."

print(introduce("신동화", "경기도", "INTP"))
print(introduce(hometown = "신동화", mbti = "경기도", name = "INTP"))   # 키워드 인자
print(introduce(hometown = "경기도", name = "신동화"))  
...
def pocket_money(left, *args, **kwargs):
    tot = left
    tot += sum(args)
    tot += sum(kwargs.values())
    return tot
print(pocket_money(500, 100, 200, father=10000, mother=5000))
print(pocket_money(500, 100, 200, 300, father=10000, mother=5000, uncle=100000))